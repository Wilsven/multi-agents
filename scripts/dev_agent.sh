...
# Run docker compose using the base file and the Agent dev override
docker compose -f docker-compose.yml -f docker-compose.dev.agent.yml up --build --remove-orphans
